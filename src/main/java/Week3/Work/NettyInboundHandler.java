...
import Week3.NIO_Gateway.outbound.httpclient4.HttpOutboundHandler;
...
public class NettyInboundHandler extends ChannelInboundHandlerAdapter {
    ...
    private NettyHeaderHttpRequestFilter filter = new NettyHeaderHttpRequestFilter();
    
    public NettyInboundHandler(List<String> proxyServer) {
        this.proxyServer = proxyServer;
        this.handler = new NettyHttpOutboundHandler(this.proxyServer);
    }
